// Version 1.43.1 three-forcegraph - https://github.com/vasturiano/three-forcegraph
...
`;
  ...
  var ThreeDigest = /*#__PURE__*/function (_DataBindMapper) {
    function ThreeDigest(scene) {
      ...
      _classCallCheck$2(this, ThreeDigest);
      _this = _callSuper(this, ThreeDigest);
      _defineProperty(_this, "scene", void 0);
      _classPrivateFieldInitSpec$1(_this, _dataBindAttr, void 0);
      _classPrivateFieldInitSpec$1(_this, _objBindAttr, void 0);
      _this.scene = scene;
      _classPrivateFieldSet2$1(_dataBindAttr, _this, dataBindAttr);
      _classPrivateFieldSet2$1(_objBindAttr, _this, objBindAttr);
      _this.onRemoveObj(function () {});
      return _this;
    }
    _inherits(ThreeDigest, _DataBindMapper);
    return _createClass$2(ThreeDigest, [{
      key: "onCreateObj",
      value: function onCreateObj(fn) {
        var _this2 = this;
        _superPropGet(ThreeDigest, "onCreateObj", this)([function (d) {
          var obj = fn(d);
          d[_classPrivateFieldGet2$1(_objBindAttr, _this2)] = obj;
          obj[_classPrivateFieldGet2$1(_dataBindAttr, _this2)] = d;
      ...
      value: function onRemoveObj(fn) {
        ...
        _superPropGet(ThreeDigest, "onRemoveObj", this)([function (obj, dId) {
          ...
          emptyObject(obj);
          delete d[_classPrivateFieldGet2$1(_objBindAttr, _this3)];
        }]);
        return this;
      }
    }]);
    ...
    methods: {
      ...
      tickFrame: function tickFrame(state) {
        ...
        function updateArrows() {
          ...
          state.arrowDataMapper.entries().forEach(function (_ref5) {
            ...
            var headVec = _construct(three$1.Vector3, _toConsumableArray$1(['x', 'y', 'z'].map(function (c) {
              return arrowHead[c];
            })));
        ...
        function updatePhotons() {
          ...
          var particleOffsetAccessor = index(state.linkDirectionalParticleOffset);
      ...
      emitParticle: function emitParticle(state, link) {
        if (link && state.graphData.links.includes(link)) {
          ...
          var particleObj = index(state.linkDirectionalParticleThreeObject)(link);
    ...
    update: function update(state, changedProps) {
      ...
      if (state._flushObjects || hasAnyPropChanged(['graphData', 'linkThreeObject', 'linkThreeObjectExtend', 'linkMaterial', 'linkColor', 'linkWidth', 'linkVisibility', 'linkResolution', 'linkOpacity', 'linkDirectionalArrowLength', 'linkDirectionalArrowColor', 'linkDirectionalArrowResolution', 'linkDirectionalParticles', 'linkDirectionalParticleWidth', 'linkDirectionalParticleColor', 'linkDirectionalParticleResolution', 'linkDirectionalParticleThreeObject'])) {
        ...
        if (state.linkDirectionalParticles || changedProps.hasOwnProperty('linkDirectionalParticles')) {
          ...
          var particleWidthAccessor = index(state.linkDirectionalParticleWidth);
          var particleColorAccessor = index(state.linkDirectionalParticleColor);
          var particleObjectAccessor = index(state.linkDirectionalParticleThreeObject);
  ...
  function fromKapsule (kapsule) {
    ...
    var ForceGraph = /*#__PURE__*/function (_baseClass) {
      function ForceGraph() {
        var _this;
        _classCallCheck$2(this, ForceGraph);
        for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
          args[_key] = arguments[_key];
        }
        _this = _callSuper(this, ForceGraph, [].concat(args));
        _this.__kapsuleInstance = _construct(kapsule, [].concat(_toConsumableArray$1(initKapsuleWithSelf ? [_this] : []), args));
        return _this;
      }
      _inherits(ForceGraph, _baseClass);
      return _createClass$2(ForceGraph);
